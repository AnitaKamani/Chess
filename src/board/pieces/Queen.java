...
public class Queen extends Pieces {
	public static char name = 'Q';

	public static Image white_image = toolkit.getImage("img/pieces/White_Queen.png");
	public static Image black_image = toolkit.getImage("img/pieces/Black_Queen.png");
	public static Image white_image30 = toolkit.getImage("img/pieces/30/wq30.png");
	public static Image black_image30 = toolkit.getImage("img/pieces/30/bq30.png");
	...
	public Queen(int color, String location) {
		...
		for (int j = 1; j <= 7; j++)
			this.pieces_moves.addAll(Arrays.asList("0,-" + j, j + ",-" + j, j + ",0", j + "," + j, "0," + j,
					(-j) + "," + j, -j + ",0", (-j) + "," + (-j)));
